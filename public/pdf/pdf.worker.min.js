...
const e = !('object' != typeof process || process + '' != '[object process]' || process.versions.nw || (process.versions.electron && process.type && 'browser' !== process.type)),
  ...
  f = { PRINT: 4, MODIFY_CONTENTS: 8, COPY: 16, MODIFY_ANNOTATIONS: 32, FILL_INTERACTIVE_FORMS: 256, COPY_FOR_ACCESSIBILITY: 512, ASSEMBLE: 1024, PRINT_HIGH_QUALITY: 2048 },
  b = 0,
  A = 1,
  v = 2,
  y = 3,
...
class util_FeatureTest {
  ...
  static get platform() {
    return 'undefined' != typeof navigator && 'string' == typeof navigator?.platform
      ? shadow(this, 'platform', { isMac: navigator.platform.includes('Mac'), isWindows: navigator.platform.includes('Win'), isFirefox: 'string' == typeof navigator?.userAgent && navigator.userAgent.includes('Firefox') })
...
class AnnotationEditorUIManager {
  ...
  #ot = null;
  #lt = null;
  #ht = { isEditing: !1, isEmpty: !0, hasSomethingToUndo: !1, hasSomethingToRedo: !1, hasSelectedEditor: !1, hasSelectedText: !1 };
  #dt = [0, 0];
  #ct = null;
  #ut = null;
  #pt = null;
  ...
  static get _keyboardManager() {
    const t = AnnotationEditorUIManager.prototype,
      arrowChecker = (t) => t.#ut.contains(document.activeElement) && 'BUTTON' !== document.activeElement.tagName && t.hasSomethingToControl(),
    ...
    return shadow(
      ...
      new KeyboardManager([
        ...
        [['Backspace', 'alt+Backspace', 'ctrl+Backspace', 'shift+Backspace', 'mac+Backspace', 'mac+alt+Backspace', 'mac+ctrl+Backspace', 'Delete', 'ctrl+Delete', 'shift+Delete', 'mac+Delete'], t.delete, { checker: textInputChecker }],
        [['Enter', 'mac+Enter'], t.addNewEditorFromKeyboard, { checker: (t, { target: e }) => !(e instanceof HTMLButtonElement) && t.#ut.contains(e) && !t.isEnterHandled }],
        [[' ', 'mac+ '], t.addNewEditorFromKeyboard, { checker: (t, { target: e }) => !(e instanceof HTMLButtonElement) && t.#ut.contains(document.activeElement) }],
  ...
  get hcmFilter() {
    return shadow(this, 'hcmFilter', this.#ot ? this.#V.addHCMFilter(this.#ot.foreground, this.#ot.background) : 'none');
  }
  get direction() {
    return shadow(this, 'direction', getComputedStyle(this.#ut).direction);
  }
  get highlightColors() {
    return shadow(this, 'highlightColors', this.#X ? new Map(this.#X.split(',').map((t) => t.split('=').map((t) => t.trim()))) : null);
  }
  ...
  highlightSelection(t = '') {
    ...
    const h = this.#vt(o),
      d = this.#nt === g.NONE,
      callback = () => {
        h?.createAndAddNewEditor({ x: 0, y: 0 }, !1, { methodOfCreation: t, boxes: l, anchorNode: i, anchorOffset: s, focusNode: n, focusOffset: a, text: r });
  ...
  setEditingState(t) {
    if (t) {
      this.#Et();
      this.#Tt();
      this.#xt({ isEditing: this.#nt !== g.NONE, isEmpty: this.#Dt(), hasSomethingToUndo: this.#L.hasSomethingToUndo(), hasSomethingToRedo: this.#L.hasSomethingToRedo(), hasSelectedEditor: !1 });
    } else {
      this.#Ct();
      this.#Mt();
      this.#xt({ isEditing: !1 });
  ...
  setUpDragSession() {
    if (this.hasSelection) {
      ...
      this.#H = new Map();
      for (const t of this.#at) this.#H.set(t, { savedX: t.x, savedY: t.y, savedPageIndex: t.pageIndex, newX: 0, newY: 0, newPageIndex: -1 });
    }
  }
  endDragSession() {
    if (!this.#H) return !1;
  ...
  getSelectionBoxes(t) {
    ...
    for (let t = 0, i = e.rangeCount; t < i; t++) {
      ...
      if (!i.collapsed) for (const { x: t, y: e, width: s, height: n } of i.getClientRects()) 0 !== s && 0 !== n && o.push(r(t, e, s, n));
    }
...
class AltText {
  ...
  async render() {
    ...
    const onClick = (t) => {
      ...
      this.#Vt && this.#a._reportTelemetry({ action: 'pdfjs.image.alt_text.image_status_label_clicked', data: { label: this.#qt } });
    };
  ...
  async setGuessedText(t) {
    if (null === this.#o) {
      this.#Wt = t;
      this.#Gt = await AltText._l10n.get('pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer', { generatedAltText: t });
      this.#Xt();
    }
  }
  ...
  serialize(t) {
    ...
    return { altText: e, decorative: this.#Ot, guessedText: this.#Wt, textWithDisclaimer: this.#Gt };
  }
  get data() {
  ...
  shown() {
    this.#a._reportTelemetry({ action: 'pdfjs.image.alt_text.image_status_label_displayed', data: { label: this.#qt } });
  }
  destroy() {
    this.#Nt?.remove();
    this.#Nt = null;
  ...
  async #Xt() {
    ...
    if (this.#Ot) e.setAttribute('data-l10n-id', 'pdfjs-editor-alt-text-decorative-tooltip');
    else {
...
class AnnotationEditor {
  ...
  focusin(t) {
    this._focusEventsAllowed && (this.#se ? (this.#se = !1) : this.parent.setSelected(this));
  }
  focusout(t) {
  ...
  #ve(t, e) {
    ...
    window.addEventListener('pointermove', this.#ye.bind(this, t), { passive: !0, capture: !0, signal: a });
  ...
  #ye(t, e) {
    ...
    } else m ? (w = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - _))) / r) : (x = Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - E))) / o);
    const T = round(r * w),
      M = round(o * x);
    A = transf(...p(T, M));
    const k = v - A[0],
  ...
  keydown(t) {
    ...
    this.#te = { savedX: this.x, savedY: this.y, savedWidth: this.width, savedHeight: this.height };
    ...
    const n = (((360 - this.rotation + this.parentRotation) % 360) / 90) * (this.#Yt.length / 4);
    if (n !== s) {
      if (n < s) for (let t = 0; t < s - n; t++) this.#Zt.append(this.#Zt.firstChild);
      else if (n > s) for (let t = 0; t < n - s; t++) this.#Zt.firstChild.before(this.#Zt.lastChild);
      let t = 0;
      for (const i of e) {
...
class MurmurHash3_64 {
  ...
  hexdigest() {
    ...
    e = ((4283543511 * e) & pt) | (((2950163797 * ((e << 16) | (t >>> 16))) & pt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & pt) | ((60499 * t) & gt);
    e = ((3301882366 * e) & pt) | (((3120437893 * ((e << 16) | (t >>> 16))) & pt) >>> 16);
    t ^= e >>> 1;
...
class AnnotationStorage {
  ...
  remove(t) {
    ...
    if ('function' == typeof this.onAnnotationEditor) {
      for (const t of this.#Fe.values()) if (t instanceof AnnotationEditor) return;
      this.onAnnotationEditor(null);
    }
  }
  setValue(t, e) {
    ...
    s && this.#De();
    e instanceof AnnotationEditor && 'function' == typeof this.onAnnotationEditor && this.onAnnotationEditor(e.constructor._type);
  }
  has(t) {
  ...
  get modifiedIds() {
    ...
    const t = [];
    for (const e of this.#Fe.values()) e instanceof AnnotationEditor && e.annotationElementId && e.serialize() && t.push(e.annotationElementId);
...
class FontLoader {
  ...
  get isSyncFontLoadingSupported() {
    let t = !1;
    (e || ('undefined' != typeof navigator && 'string' == typeof navigator?.userAgent && /Mozilla\/5.0.*?rv:\d+.*? Gecko/.test(navigator.userAgent))) && (t = !0);
...
class BaseCanvasFactory {
  ...
  create(t, e) {
    ...
    return { canvas: i, context: i.getContext('2d', { willReadFrequently: !this.#Le }) };
  }
  reset(t, e, i) {
...
class MeshShadingPattern extends BaseShadingPattern {
  ...
  getPattern(t, e, i, s) {
    applyBoundingBox(t, this._bbox);
    let n;
    if (s === yt) n = Util.singularValueDecompose2dScale(getCurrentTransform(t));
    else {
    ...
    const a = this._createMeshCanvas(n, s === yt ? null : this._background, e.cachedCanvases);
    if (s !== yt) {
...
function convertBlackAndWhiteToRGBA({ src: t, srcPos: e = 0, dest: i, width: s, height: n, nonBlackColor: a = 4294967295, inverseDecode: r = !1 }) {
...
class CanvasGraphics {
  ...
  _createMaskCanvas(t) {
    ...
    if ((t.bitmap || t.data) && t.count > 1) {
      ...
      const i = o.get(l);
      if (i && !a) {
        return { canvas: i, offsetX: Math.round(Math.min(r[0], r[2]) + r[4]), offsetY: Math.round(Math.min(r[1], r[3]) + r[5]) };
      }
      h = i;
    }
    if (!h) {
  ...
  genericComposeSMask(t, e, i, s, n, a, r, o, l, h, d) {
    ...
    'Alpha' === n && r ? (e.filter = this.filterFactory.addAlphaFilter(r)) : 'Luminosity' === n && (e.filter = this.filterFactory.addLuminosityFilter(r));
    const g = new Path2D();
    g.rect(o, l, i, s);
    e.clip(g);
  ...
  stroke(t = !0) {
    ...
    if (this.contentVisible)
      if ('object' == typeof i && i?.getPattern) {
        e.save();
        e.strokeStyle = i.getPattern(e, this, getCurrentTransformInverse(e), vt);
  ...
  showText(t) {
    ...
    if (e.patternFill) {
      n.save();
      const t = e.fillColor.getPattern(n, this, getCurrentTransformInverse(n), At);
  ...
  getColorN_Pattern(t) {
    ...
    if ('TilingPattern' === t[0]) {
      const i = t[1],
        ...
        n = { createCanvasGraphics: (t) => new CanvasGraphics(t, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, { optionalContentConfig: this.optionalContentConfig, markedContentStack: this.markedContentStack }) };
  ...
  beginGroup(t) {
    ...
    c.translate(-a, -r);
    c.transform(...i);
    if (t.smask) this.smaskStack.push({ canvas: d.canvas, context: c, offsetX: a, offsetY: r, subtype: t.smask.subtype, backdrop: t.smask.backdrop, transferMap: t.smask.transferMap || null, startTransformInverse: null });
    else {
      e.setTransform(1, 0, 0, 1, 0, 0);
      e.translate(a, r);
      e.save();
  ...
  paintImageMaskXObjectGroup(t) {
    ...
    for (const n of t) {
      ...
      h.fillStyle = s ? i.getPattern(h, this, getCurrentTransformInverse(e), At) : i;
      h.fillRect(0, 0, a, r);
      h.restore();
      e.save();
      e.transform(...o);
  ...
  paintImageXObjectRepeat(t, e, i, s) {
    ...
    const a = n.width,
      r = n.height,
      o = [];
    for (let t = 0, n = s.length; t < n; t += 2) o.push({ transform: [e, 0, 0, i, s[t], s[t + 1]], x: 0, y: 0, w: a, h: r });
...
for (const t in X) void 0 !== CanvasGraphics.prototype[t] && (CanvasGraphics.prototype[X[t]] = CanvasGraphics.prototype[t]);
...
class MessageHandler {
  ...
  constructor(t, e, i) {
    ...
    i.addEventListener('message', this.#Ue.bind(this), { signal: this.#ze.signal });
  }
  #Ue({ data: t }) {
    ...
    if (t.callbackId) {
      ...
      new Promise(function (i) {
        ...
        function (e) {
          n.postMessage({ sourceName: i, targetName: s, callback: Mt, callbackId: t.callbackId, data: e });
        },
        function (e) {
          n.postMessage({ sourceName: i, targetName: s, callback: kt, callbackId: t.callbackId, reason: wrapReason(e) });
        }
      );
    ...
    return new ReadableStream(
      {
        start: (i) => {
          ...
          o.postMessage({ sourceName: a, targetName: r, action: t, streamId: n, data: e, desiredSize: i.desiredSize }, s);
          return l.promise;
        },
        pull: (t) => {
          const e = Promise.withResolvers();
          this.streamControllers[n].pullCall = e;
          o.postMessage({ sourceName: a, targetName: r, stream: Lt, streamId: n, desiredSize: t.desiredSize });
          return e.promise;
        },
        cancel: (t) => {
          ...
          o.postMessage({ sourceName: a, targetName: r, stream: Pt, streamId: n, reason: wrapReason(t) });
          return e.promise;
        },
      },
      i
  ...
  #We(t) {
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage({ sourceName: i, targetName: s, stream: Rt, streamId: e, chunk: t }, r);
        },
        close() {
          if (!this.isCancelled) {
            this.isCancelled = !0;
            n.postMessage({ sourceName: i, targetName: s, stream: Dt, streamId: e });
        ...
        error(t) {
          ...
          if (!this.isCancelled) {
            this.isCancelled = !0;
            n.postMessage({ sourceName: i, targetName: s, stream: It, streamId: e, reason: wrapReason(t) });
          }
        },
    ...
    new Promise(function (e) {
      ...
      function () {
        n.postMessage({ sourceName: i, targetName: s, stream: Nt, streamId: e, success: !0 });
      },
      function (t) {
  ...
  #je(t) {
    ...
    switch (t.stream) {
      ...
      case Lt:
        if (!r) {
          n.postMessage({ sourceName: i, targetName: s, stream: Ot, streamId: e, success: !0 });
          break;
        }
        ...
        new Promise(function (t) {
          ...
          function (t) {
            n.postMessage({ sourceName: i, targetName: s, stream: Ot, streamId: e, reason: wrapReason(t) });
          }
        );
        break;
      case Rt:
      ...
      case Pt:
        ...
        new Promise(function (e) {
          ...
          function () {
            n.postMessage({ sourceName: i, targetName: s, stream: Ft, streamId: e, success: !0 });
          },
          function (t) {
            n.postMessage({ sourceName: i, targetName: s, stream: Ft, streamId: e, reason: wrapReason(t) });
          }
        );
...
class OptionalContentGroup {
  ...
  get visible() {
    ...
    return this.#qe ? 'OFF' !== e?.viewState : !this.#Xe || 'OFF' !== t?.printState;
  }
  _setVisible(t, e, i = !1) {
...
class OptionalContentConfig {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      this.#ti = t.order;
      for (const i of t.groups) this.#Je.set(i.id, new OptionalContentGroup(e, i));
      if ('OFF' === t.baseState) for (const t of this.#Je.values()) t._setVisible(Bt, !1);
  ...
  setVisibility(t, e = !0, i = !0) {
    ...
    if (s) {
      if (i && e && s.rbGroups.length) for (const e of s.rbGroups) for (const i of e) i !== t && this.#Je.get(i)?._setVisible(Bt, !1, !0);
  ...
  getOrder() {
    return this.#Je.size ? (this.#ti ? this.#ti.slice() : [...this.#Je.keys()]) : null;
  }
  getGroups() {
...
function createResponseStatusError(t, e) {
  return 404 === t || (0 === t && e.startsWith('file:')) ? new MissingPDFException('Missing PDF "' + e + '".') : new UnexpectedResponseException(`Unexpected server response (${t}) while retrieving PDF "${e}".`, t);
}
...
class PDFNetworkStreamFullRequestReader {
  ...
  _onHeadersReceived() {
    const t = this._fullRequestId,
      ...
      { allowRangeRequests: s, suggestedLength: n } = validateRangeRequestCapabilities({ responseHeaders: i, isHttp: this._manager.isHttp, rangeChunkSize: this._rangeChunkSize, disableRange: this._disableRange });
  ...
  constructor(t) {
    ...
    this._request = createRequest(this._url, e, (e) => {
      ...
      const i = new Headers(this._readableStream.headers),
        { allowRangeRequests: s, suggestedLength: n } = validateRangeRequestCapabilities({ responseHeaders: i, isHttp: t.isHttp, rangeChunkSize: this._rangeChunkSize, disableRange: this._disableRange });
...
class TextLayer {
  ...
  #Mi(t) {
    ...
    e.textContent = t.str;
    e.dir = t.dir;
    this.#ni && (e.dataset.fontName = a.fontSubstitutionLoadedName || t.fontName);
    ...
    : class DOMFilterFactory extends BaseFilterFactory {
        ...
        #zi(t) {
          if (void 0 === this.#Fi) {
            this.#Fi = '';
            const t = this.#Li.URL;
            t !== this.#Li.baseURI && (isDataScheme(t) ? warn('#createUrl: ignore "data:"-URL for performance reasons.') : (this.#Fi = t.split('#', 1)[0]));
          }
        ...
        addHighlightHCMFilter(t, e, i, s, n) {
          ...
          this.#Gi(g);
          this.#ji(getSteps(c[0], u[0], 5), getSteps(c[1], u[1], 5), getSteps(c[2], u[2], 5), g);
          r.url = this.#zi(p);
          return r.url;
        }
        destroy(t = !1) {
...
function getDocument(t = {}) {
  ...
  const i = new PDFDocumentLoadingTask(),
    ...
    a = t.data
      ? (function getDataProp(t) {
          if (e && 'undefined' != typeof Buffer && t instanceof Buffer) throw new Error('Please provide binary data as `Uint8Array`, rather than `Buffer`.');
    ...
    d = Number.isInteger(t.rangeChunkSize) && t.rangeChunkSize > 0 ? t.rangeChunkSize : Ut;
  ...
  const u = t.verbosity,
    ...
    _ = 'boolean' == typeof t.isChrome ? t.isChrome : !util_FeatureTest.platform.isFirefox && 'undefined' != typeof window && !!window?.chrome,
    ...
    B = 'boolean' == typeof t.useWorkerFetch ? t.useWorkerFetch : f === DOMCMapReaderFactory && A === DOMStandardFontDataFactory && g && b && isValidFetchUrl(g, document.baseURI) && isValidFetchUrl(b, document.baseURI);
  ...
  const z = {
    ...
    U = { disableFontFace: C, fontExtraProperties: S, ownerDocument: M, pdfBug: D, styleElement: null, loadingParams: { disableAutoFetch: F, enableXfa: T } };
  c.promise
    .then(function () {
      if (i.destroyed) throw new Error('Loading aborted');
      if (c.destroyed) throw new Error('Worker was destroyed');
      const t = c.messageHandler.sendWithPromise('GetDocRequest', z, a ? [a.buffer] : null);
      let l;
      if (h) l = new PDFDataTransportStream(h, { disableRange: k, disableStream: P });
      else if (!a) {
        if (!n) throw new Error('getDocument - no `url` parameter provided.');
        let t;
        if (e) {
          t = 'undefined' != typeof fetch && 'undefined' != typeof Response && 'body' in Response.prototype && isValidFetchUrl(n) ? PDFFetchStream : PDFNodeStream;
        } else t = isValidFetchUrl(n) ? PDFFetchStream : PDFNetworkStream;
        l = new t({ url: n, length: O, httpHeaders: r, withCredentials: o, rangeChunkSize: d, disableRange: k, disableStream: P });
      }
      return t.then((t) => {
        if (i.destroyed) throw new Error('Loading aborted');
        if (c.destroyed) throw new Error('Worker was destroyed');
...
class PDFPageProxy {
    ...
    Promise.all([f.displayReadyCapability.promise, r])
      .then(([t, e]) => {
        if (this.destroyed) complete();
          ...
          if (!(e.renderingIntent & g)) throw new Error('Must use the same `intent`-argument when calling the `PDFPageProxy.render` and `PDFDocumentProxy.getOptionalContentConfig` methods.');
  ...
  getOperatorList({ intent: t = 'display', annotationMode: e = p.ENABLE, printAnnotationStorage: i = null, isEditing: s = !1 } = {}) {
  ...
  _pumpOperatorList({ renderingIntent: t, cacheKey: e, annotationStorageSerializable: i, modifiedIds: s }) {
    const { map: n, transfer: a } = i,
      r = this._transport.messageHandler.sendWithStream('GetOperatorList', { pageIndex: this._pageIndex, intent: t, cacheKey: e, annotationStorage: n, modifiedIds: s }, a).getReader(),
...
class PDFWorker {
  ...
  constructor({ name: t = null, port: e = null, verbosity: i = getVerbosityLevel() } = {}) {
    ...
    if (e) {
      if (PDFWorker.#is?.has(e)) throw new Error('Cannot use more than one PDFWorker per port.');
  ...
  _initialize() {
    ...
    try {
      PDFWorker._isSameOrigin(window.location.href, t) || (t = PDFWorker._createCDNWrapper(new URL(t, window.location).href));
...
class WorkerTransport {
  ...
  destroy() {
    ...
    this.#hs?.reject(new Error('Worker was destroyed during onPassword callback'));
    const t = [];
    ...
    t.on('PasswordRequest', (t) => {
      ...
      if (e.onPassword) {
        const updatePassword = (t) => {
          t instanceof Error ? this.#hs.reject(t) : this.#hs.resolve({ password: t });
        };
        try {
  ...
  getPageIndex(t) {
    return isRefProxy(t) ? this.messageHandler.sendWithPromise('GetPageIndex', { num: t.num, gen: t.gen }) : Promise.reject(new Error('Invalid pageIndex request.'));
  }
  getAnnotations(t, e) {
  ...
  getOptionalContentConfig(t) {
    return this.#ds('GetOptionalContentConfig').then((e) => new OptionalContentConfig(e, t));
  }
  getPermissions() {
  ...
  getMetadata() {
    ...
    const i = this.messageHandler
      ...
      .then((t) => ({ info: t[0], metadata: t[1] ? new Metadata(t[1]) : null, contentDispositionFilename: this._fullReader?.filename ?? null, contentLength: this._fullReader?.contentLength ?? null }));
    this.#as.set(t, i);
    return i;
  }
  getMarkInfo() {
...
class PDFObjects {
  ...
  get(t, e = null) {
    ...
    const i = this.#cs[t];
    if (!i || i.data === $t) throw new Error(`Requesting object that isn't resolved yet ${t}.`);
    return i.data;
  }
  has(t) {
    const e = this.#cs[t];
...
class InternalRenderTask {
  ...
  constructor({ callback: t, params: e, objs: i, commonObjs: s, annotationCanvasMap: n, operatorList: a, pageIndex: r, canvasFactory: o, filterFactory: l, useRequestAnimationFrame: h = !1, pdfBug: d = !1, pageColors: c = null }) {
    this.callback = t;
    this.params = e;
    this.objs = i;
    this.commonObjs = s;
  ...
  initializeGraphics({ transparency: t = !1, optionalContentConfig: e }) {
    ...
    if (this._canvas) {
      if (InternalRenderTask.#ms.has(this._canvas)) throw new Error('Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.');
    ...
    this.gfx = new CanvasGraphics(i, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, { optionalContentConfig: e }, this.annotationCanvasMap, this.pageColors);
...
class AnnotationElement {
  ...
  _createContainer(t) {
    ...
    const l = Util.normalizeRect([e.rect[0], i.view[3] - e.rect[1] + i.view[1], e.rect[2], i.view[3] - e.rect[3] + i.view[1]]),
    ...
    if (this._fieldObjects) {
      ...
      if (s)
        for (const { page: t, id: n, exportValues: a } of s) {
          ...
          !r || Yt.has(r) ? i.push({ id: n, exportValue: s, domElement: r }) : warn(`_getElementsByName - element not allowed: ${n}`);
        }
      return i;
    }
    ...
    if (this._fieldObjects)
      t.onclick = () => {
        ...
        for (const t of a) {
          ...
          i && (Yt.has(i) ? i.dispatchEvent(new Event('resetform')) : warn(`_bindResetFormAction - element not allowed: ${e}`));
        }
        this.enableScripting && this.linkService.eventBus?.dispatch('dispatcheventinsandbox', { source: this, detail: { id: 'app', ids: o, name: 'ResetForm' } });
        return !1;
      };
    else {
  ...
  render() {
    ...
    if (this.enableScripting && this.hasJSActions) {
      ...
      s.addEventListener('input', (i) => {
        ...
        i.preventDefault();
        this.linkService.eventBus?.dispatch('dispatcheventinsandbox', { source: this, detail: { id: e, name: 'Keystroke', value: r, change: n, changeEx: s, willCommit: !1, commitKey: 1, keyDown: !1 } });
      });
      this._setEventListeners(
        s,
        null,
...
class PopupAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    this.container.setAttribute('aria-controls', e.map((t) => `${et}${t}`).join(','));
    return this.container;
  }
}
class PopupElement {
  ...
  #fs = null;
  #js = !1;
  constructor({ container: t, color: e, elements: i, titleObj: s, modificationDate: n, contentsObj: a, richText: r, parent: o, rect: l, parentRect: h, open: d }) {
    this.#ut = t;
    this.#Us = s;
    this.#Ds = a;
    this.#zs = r;
  ...
  render() {
    ...
    if (this.#Fs) {
      ...
      if (CSS.supports('background-color', 'color-mix(in srgb, red 30%, white)')) t.style.backgroundColor = `color-mix(in srgb, ${e} 30%, white)`;
        ...
        const e = 0.7;
        t.style.backgroundColor = Util.makeHexColor(...this.#Fs.map((t) => Math.floor(e * (255 - t) + t)));
      }
    }
    const e = document.createElement('span');
    e.className = 'header';
    ...
    if (this.#Rs) {
      ...
      t.setAttribute('data-l10n-args', JSON.stringify({ dateObj: this.#Rs.valueOf() }));
      e.append(t);
    }
    const s = this.#Ws;
    if (s) {
  ...
  get #Ws() {
    const t = this.#zs,
      e = this.#Ds;
    return !t?.str || (e?.str && e.str !== t.str) ? null : this.#zs.html || null;
  }
  get #Gs() {
  ...
  #$s(t) {
    const e = [],
      ...
      s = { style: { color: this.#Vs, fontSize: this.#Gs ? `calc(${this.#Gs}px * var(--scale-factor))` : '' } };
  ...
  #Es(t) {
    t.altKey || t.shiftKey || t.ctrlKey || t.metaKey || (('Enter' === t.key || ('Escape' === t.key && this.#Ns)) && this.#Ps());
  }
...
class AnnotationLayer {
  ...
  #sn = new Map();
  #nn = null;
  constructor({ div: t, accessibilityManager: e, annotationCanvasMap: i, annotationEditorUIManager: s, page: n, viewport: a, structTreeLayer: r }) {
    this.div = t;
    this.#en = e;
    this.#in = i;
    this.#nn = r || null;
...
class FreeTextEditor extends AnnotationEditor {
  ...
  constructor(t) {
    ...
    this.#Fs = t.color || FreeTextEditor._defaultColor || AnnotationEditor._defaultLineColor;
  ...
  #dn(t) {
    const setFontsize = (t) => {
      ...
      e = this.#Gs;
    this.addCommands({ cmd: setFontsize.bind(this, t), undo: setFontsize.bind(this, e), post: this._uiManager.updateUI.bind(this._uiManager, this), mustExec: !0, type: m.FREETEXT_SIZE, overwriteIfSameType: !0, keepUndo: !0 });
  }
  #cn(t) {
    const setColor = (t) => {
      ...
      e = this.#Fs;
    this.addCommands({ cmd: setColor.bind(this, t), undo: setColor.bind(this, e), post: this._uiManager.updateUI.bind(this._uiManager, this), mustExec: !0, type: m.FREETEXT_COLOR, overwriteIfSameType: !0, keepUndo: !0 });
  }
  _translateEmpty(t, e) {
  ...
  getInitialTranslation() {
    ...
    return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor._internalPadding + this.#Gs) * t];
  }
  rebuild() {
    if (this.parent) {
      super.rebuild();
  ...
  static #gn(t) {
    return (t.nodeType === Node.TEXT_NODE ? t.nodeValue : t.innerText).replaceAll(Qt, '');
  }
  editorDivPaste(t) {
    ...
    if (r.nodeType === Node.TEXT_NODE) {
      ...
      if (t !== this.editorDiv) {
        let e = l;
        for (const i of this.editorDiv.childNodes) i !== t ? e.push(FreeTextEditor.#gn(i)) : (e = h);
      }
  ...
  static async deserialize(t, e, i) {
    ...
    if (t instanceof FreeTextAnnotationElement) {
      ...
      s = t = { annotationType: g.FREETEXT, color: Array.from(i), fontSize: e, value: l.join('\n'), position: h, pageIndex: d - 1, rect: n.slice(0), rotation: a, id: r, deleted: !1, popupRef: o };
    }
  ...
  serialize(t = !1) {
    ...
    const e = FreeTextEditor._internalPadding * this.parentScale,
      i = this.getRect(e, e),
      s = AnnotationEditor._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#Fs),
      n = { annotationType: g.FREETEXT, color: s, fontSize: this.#Gs, value: this.#bn(), pageIndex: this.pageIndex, rect: i, rotation: this.rotation, structTreeParentId: this._structTreeParentId };
    if (t) return n;
...
class FreeDrawOutliner {
  ...
  #Ln() {
    const t = this.#En.subarray(4, 6),
      ...
      [i, s, n, a] = this.#vn;
    return [(this.#Cn + (t[0] - e[0]) / 2 - i) / n, (this.#Sn + (t[1] - e[1]) / 2 - s) / a, (this.#Cn + (e[0] - t[0]) / 2 - i) / n, (this.#Sn + (e[1] - t[1]) / 2 - s) / a];
  }
  add({ x: t, y: e }) {
    this.#Cn = t;
    this.#Sn = e;
    ...
    if (Math.abs(Math.atan2(A - o, b - r) - Math.atan2(f, m)) < Math.PI / 2) {
      ...
      this.#_n.push(NaN, NaN, NaN, NaN, ((r + l) / 2 - i) / n, ((o + h) / 2 - s) / a);
      [r, o, b, A] = this.#En.subarray(14, 18);
      this.#yn.push(NaN, NaN, NaN, NaN, ((b + r) / 2 - i) / n, ((A + o) / 2 - s) / a);
      return !0;
    }
    [b, A, r, o, l, h] = this.#En.subarray(0, 6);
    this.#_n.push(((b + 5 * r) / 6 - i) / n, ((A + 5 * o) / 6 - s) / a, ((5 * r + l) / 6 - i) / n, ((5 * o + h) / 6 - s) / a, ((r + l) / 2 - i) / n, ((o + h) / 2 - s) / a);
    [l, h, r, o, b, A] = this.#En.subarray(12, 18);
    this.#yn.push(((b + 5 * r) / 6 - i) / n, ((A + 5 * o) / 6 - s) / a, ((5 * r + l) / 6 - i) / n, ((5 * o + h) / 6 - s) / a, ((r + l) / 2 - i) / n, ((o + h) / 2 - s) / a);
    return !0;
  }
  toSVGPath() {
  ...
  #On() {
    const [t, e, i, s] = this.#vn,
      [n, a, r, o] = this.#Ln();
    return `M${(this.#En[2] - t) / i} ${(this.#En[3] - e) / s} L${(this.#En[4] - t) / i} ${(this.#En[5] - e) / s} L${n} ${a} L${r} ${o} L${(this.#En[16] - t) / i} ${(this.#En[17] - e) / s} L${(this.#En[14] - t) / i} ${
      (this.#En[15] - e) / s
    } Z`;
  }
  #Bn(t) {
  ...
  #Nn(t) {
    const [e, i, s, n] = this.#vn,
      ...
      [o, l, h, d] = this.#Ln();
    t.push(`L${(a[0] - e) / s} ${(a[1] - i) / n} L${o} ${l} L${h} ${d} L${(r[0] - e) / s} ${(r[1] - i) / n}`);
  }
  ...
  getOutlines() {
    ...
    this.#Un(l, h);
    return this.newFreeDrawOutline(l, o, this.#vn, this.#kn, this.#wn, this.#xn);
  }
  #Hn(t) {
    const e = this.#En,
      [i, s, n, a] = this.#vn,
    ...
    return this.newFreeDrawOutline(d, t, this.#vn, this.#kn, this.#wn, this.#xn);
  }
  #Un(t, e) {
    const i = this.#yn;
  ...
  #zn(t, e) {
    const i = this.#En.subarray(4, 6),
      ...
      [n, a, r, o] = this.#vn,
      [l, h, d, c] = this.#Ln();
    t.set([NaN, NaN, NaN, NaN, (i[0] - n) / r, (i[1] - a) / o, NaN, NaN, NaN, NaN, l, h, NaN, NaN, NaN, NaN, d, c, NaN, NaN, NaN, NaN, (s[0] - n) / r, (s[1] - a) / o], e);
    return e + 24;
  }
}
class FreeDrawOutline extends Outline {
  ...
  toSVGPath() {
    ...
    for (let e = 6, i = this.#Wn.length; e < i; e += 6)
      isNaN(this.#Wn[e]) ? t.push(`L${this.#Wn[e + 4]} ${this.#Wn[e + 5]}`) : t.push(`C${this.#Wn[e]} ${this.#Wn[e + 1]} ${this.#Wn[e + 2]} ${this.#Wn[e + 3]} ${this.#Wn[e + 4]} ${this.#Wn[e + 5]}`);
    t.push('Z');
    return t.join(' ');
  }
  serialize([t, e, i, s], n) {
  ...
  getNewOutline(t, e) {
    const { x: i, y: s, width: n, height: a } = this.#jn,
      ...
      u = i * l + r,
      p = s * h + o,
      g = this.newOutliner({ x: this.#Fn[0] * d + u, y: this.#Fn[1] * c + p }, this.#vn, this.#kn, t, this.#xn, e ?? this.#wn);
    for (let t = 2; t < this.#Fn.length; t += 2) g.add({ x: this.#Fn[t] * d + u, y: this.#Fn[t + 1] * c + p });
...
class ColorPicker {
  ...
  constructor({ editor: t = null, uiManager: e = null }) {
    ...
    this.#sa = t?.color || this.#m?.highlightColors.values().next().value || '#FFFF98';
  ...
  #pa(t, e) {
    e.stopPropagation();
    this.#oa.dispatch('switchannotationeditorparams', { source: this, type: this.#ha, value: t });
  }
  ...
  _moveToNext(t) {
    this.#ga ? (t.target !== this.#ea ? t.target.nextSibling?.focus() : this.#na.firstChild?.focus()) : this.#ca(t);
  }
  _moveToPrevious(t) {
  ...
  #ca(t) {
    ...
    if (!this.#la) {
      ...
      window.addEventListener('pointerdown', this.#h.bind(this), { signal: this.#m.combinedSignal(this.#la) });
    }
    if (this.#na) {
  ...
  updateColor(t) {
    ...
    for (const i of this.#na.children) i.setAttribute('aria-selected', e.next().value === t);
  }
  destroy() {
    this.#ea?.remove();
    this.#ea = null;
...
class HighlightEditor extends AnnotationEditor {
  ...
  get telemetryInitialData() {
    return { action: 'added', type: this.#Ea ? 'free_highlight' : 'highlight', color: this._uiManager.highlightColorNames.get(this.color), thickness: this.#Pn, methodOfCreation: this.#ka };
  }
  get telemetryFinalData() {
  ...
  #Da() {
    ...
    ({ x: this.x, y: this.y, width: this.width, height: this.height } = this.#_a.box);
    const e = new HighlightOutliner(this.#ba, 0.0025, 0.001, 'ltr' === this._uiManager.direction);
  ...
  #Pa({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    ...
    if (e >= 0) {
      ...
      this.parent.drawLayer.updateBox(this.#v, HighlightEditor.#Ra(this.#_a.box, (e - this.rotation + 360) % 360));
      this.parent.drawLayer.updateLine(this.#Ta, this.#va);
      this.parent.drawLayer.updateBox(this.#Ta, HighlightEditor.#Ra(this.#va.box, e));
    }
  ...
  #Ia(t) {
    ...
    this.addCommands({ cmd: setThickness.bind(this, t), undo: setThickness.bind(this, e), post: this._uiManager.updateUI.bind(this._uiManager, this), mustExec: !0, type: m.INK_THICKNESS, overwriteIfSameType: !0, keepUndo: !0 });
  ...
  #Fa(t = this.parent) {
    if (null === this.#v) {
      ({ id: this.#v, clipPathId: this.#Aa } = t.drawLayer.draw(this.#_a, this.color, this.#Sa));
  ...
  render() {
    ...
    this.#Ea ? t.classList.add('free') : this.div.addEventListener('keydown', this.#Ba.bind(this), { signal: this._uiManager._signal });
  ...
  static startHighlighting(t, e, { target: i, x: s, y: n }) {
    ...
    this._freeHighlight = new FreeHighlightOutliner({ x: s, y: n }, [a, r, o, l], t.scale, this._defaultThickness / 2, e, 0.001);
    ({ id: this._freeHighlightId, clipPathId: this._freeHighlightClipId } = t.drawLayer.draw(this._freeHighlight, this._defaultColor, this._defaultOpacity, !0));
  }
  static #Wa(t, e) {
  ...
  static #ja(t, e) {
    this._freeHighlight.isEmpty()
      ...
      : t.createAndAddNewEditor(e, !1, { highlightId: this._freeHighlightId, highlightOutlines: this._freeHighlight.getOutlines(), clipPathId: this._freeHighlightClipId, methodOfCreation: 'main_toolbar' });
  ...
  static async deserialize(t, e, i) {
    ...
    if (t instanceof HighlightAnnotationElement) {
      ...
      s = t = { annotationType: g.HIGHLIGHT, color: Array.from(r), opacity: o, quadPoints: e, boxes: null, pageIndex: h - 1, rect: i.slice(0), rotation: n, id: a, deleted: !1, popupRef: l };
      ...
      s = t = { annotationType: g.HIGHLIGHT, color: Array.from(r), thickness: o, inkLists: e, boxes: null, pageIndex: h - 1, rect: i.slice(0), rotation: n, id: a, deleted: !1, popupRef: l };
    }
    ...
    if (a) {
      const t = (l.#ba = []);
      for (let e = 0; e < a.length; e += 8) t.push({ x: (a[e] - c) / h, y: 1 - (a[e + 1] - u) / d, width: (a[e + 2] - a[e]) / h, height: (a[e + 1] - a[e + 5]) / d });
      l.#Da();
      l.#Fa();
      l.rotate(l.rotation);
    } else if (r) {
      ...
      const { id: n, clipPathId: a } = e.drawLayer.draw(s, l.color, l._defaultOpacity, !0);
      l.#Pa({ highlightOutlines: s.getOutlines(), highlightId: n, clipPathId: a });
      l.#Fa();
    }
    return l;
  }
...
class InkEditor extends AnnotationEditor {
  ...
  #cn(t) {
    const setColor = (t) => {
      ...
      e = this.color;
    this.addCommands({ cmd: setColor.bind(this, t), undo: setColor.bind(this, e), post: this._uiManager.updateUI.bind(this._uiManager, this), mustExec: !0, type: m.INK_COLOR, overwriteIfSameType: !0, keepUndo: !0 });
  }
  #sr(t) {
    const setOpacity = (t) => {
      this.opacity = t;
    ...
    this.addCommands({ cmd: setOpacity.bind(this, t), undo: setOpacity.bind(this, e), post: this._uiManager.updateUI.bind(this._uiManager, this), mustExec: !0, type: m.INK_OPACITY, overwriteIfSameType: !0, keepUndo: !0 });
  }
  rebuild() {
    if (this.parent) {
      super.rebuild();
  ...
  #Tr(t, e, i, s) {
    ...
    for (const e of this.paths) {
      ...
      n.push({ bezier: InkEditor.#Cr(i, s, this.rotation), points: InkEditor.#Cr(a, s, this.rotation) });
    }
    return n;
  }
  #Mr() {
  ...
  serialize() {
    ...
    return {
      ...
      paths: this.#Tr(this.scaleFactor / this.parentScale, this.translationX, this.translationY, t),
      pageIndex: this.pageIndex,
      rect: t,
...
class StampEditor extends AnnotationEditor {
  ...
  #zr() {
    ...
    if (this.#Lr)
      if (this._uiManager.useNewAltTextWhenAddingImage && this._uiManager.useNewAltTextFlow && this.#kr) {
        this._editToolbar.hide();
  ...
  #Vr(t) {
    ...
    if (this.#Nr) {
      ...
      n.getContext('2d').drawImage(this.#kr, 0, 0, this.#kr.width, this.#kr.height, 0, 0, i, s);
  ...
  static async deserialize(t, e, i) {
    ...
    if (t instanceof StampAnnotationElement) {
      ...
      c.remove();
      const p = (await e._structTree.getAriaAttributes(`${et}${r}`))?.get('aria-label') || '';
      s = t = { annotationType: g.STAMP, bitmapId: u.id, bitmap: u.bitmap, pageIndex: d - 1, rect: n.slice(0), rotation: a, id: r, deleted: !1, accessibilityData: { decorative: !1, altText: p }, isSvg: !1, structParent: o, popupRef: l };
    }
    const n = await super.deserialize(t, e, i),
  ...
  serialize(t = !1, e = null) {
    if (this.isEmpty()) return null;
    if (this.deleted) return this.serializeDeleted();
    const i = { annotationType: g.STAMP, bitmapId: this.#Pr, pageIndex: this.pageIndex, rect: this.getRect(0, 0), rotation: this.rotation, isSvg: this.#Nr, structTreeParentId: this._structTreeParentId };
    if (t) {
    ...
    if (null === e) return i;
    e.stamps ||= new Map();
    const a = this.#Nr ? (i.rect[2] - i.rect[0]) * (i.rect[3] - i.rect[1]) : null;
...
class AnnotationEditorLayer {
  ...
  constructor({ uiManager: t, pageIndex: e, div: i, structTreeLayer: s, accessibilityManager: n, annotationLayer: a, drawLayer: r, textLayer: o, viewport: l, l10n: h }) {
  ...
  enableTextSelection() {
    ...
    if (this.#to?.div && !this.#eo) {
      ...
      this.#to.div.addEventListener('pointerdown', this.#so.bind(this), { signal: t });
  ...
  #so(t) {
    this.#m.unselectAll();
    const { target: e } = t;
    if (e === this.#to.div || (('img' === e.getAttribute('role') || e.classList.contains('endOfContent')) && this.#to.div.contains(e))) {
      const { isMac: e } = util_FeatureTest.platform;
      if (0 !== t.button || (t.ctrlKey && e)) return;
      this.#m.showAllEditors('highlight', !0, !0);
      this.#to.div.classList.add('free');
      this.toggleDrawing();
      HighlightEditor.startHighlighting(this, 'ltr' === this.#m.direction, { target: this.#to.div, x: t.x, y: t.y });
  ...
  detach(t) {
    ...
    !this.#Zr && t.annotationElementId && this.#m.addDeletedAnnotationElement(t);
  }
  remove(t) {
    this.detach(t);
  ...
  moveEditorInDOM(t) {
    ...
    t._structTreeParentId = this.#en?.moveElementInDOM(this.div, t.div, t.contentDiv, !0);
  }
  addOrRebuild(t) {
  ...
  pasteEditor(t, e) {
    ...
    const { offsetX: i, offsetY: s } = this.#ro(),
      n = this.getNextId(),
      a = this.#ao({ parent: this, id: n, x: i, y: s, uiManager: this.#m, isCentered: !0, ...e });
    a && this.add(a);
  }
  async deserialize(t) {
    return (await AnnotationEditorLayer.#z.get(t.annotationType ?? t.annotationEditorType)?.deserialize(t, this, this.#m)) || null;
  }
  createAndAddNewEditor(t, e, i = {}) {
    const s = this.getNextId(),
      n = this.#ao({ parent: this, id: s, x: t.offsetX, y: t.offsetY, uiManager: this.#m, isCentered: e, ...i });
    n && this.add(n);
    return n;
  }
  #ro() {
  ...
  pointerup(t) {
    const { isMac: e } = util_FeatureTest.platform;
    if (!(0 !== t.button || (t.ctrlKey && e)) && t.target === this.div && this.#Qr) {
      this.#Qr = !1;
      this.#$r ? (this.#m.getMode() !== g.STAMP ? this.createAndAddNewEditor(t, !1) : this.#m.unselectAll()) : (this.#$r = !0);
    }
  }
  pointerdown(t) {
